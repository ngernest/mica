module type ECDHIntf = sig
  ...
  val quickcheck_generator_public_key : public_key Base_quickcheck.Generator.t
  val quickcheck_generator_private_key : private_key Base_quickcheck.Generator.t
  val base : public_key
