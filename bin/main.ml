        ...
        include struct
          let int t () =
            Quickcheck.test (gen_expr IntT) ~f:(fun e ->
                ...
                | Val_IntT intT__038_, Val_IntT intT__037_ -> ())
          ...
          let bool () =
            Quickcheck.test (gen_expr Bool) ~f:(fun e ->
                match (I1.interp e, I2.interp e) with
                | Val_Bool bool__040_, Val_Bool bool__039_ -> ())
          ...
          let bool () =
            Quickcheck.test (gen_expr Bool) ~f:(fun e ->
                match (I1.interp e, I2.interp e) with
                | Val_Bool bool__042_, Val_Bool bool__041_ -> ())
          ...
          let int t () =
            Quickcheck.test (gen_expr IntT) ~f:(fun e ->
                match (I1.interp e, I2.interp e) with
                | Val_IntT intT__044_, Val_IntT intT__043_ -> ())
          ...
          let int t () =
            Quickcheck.test (gen_expr IntT) ~f:(fun e ->
                match (I1.interp e, I2.interp e) with
                | Val_IntT intT__046_, Val_IntT intT__045_ -> ())
          ...
          let int () =
            Quickcheck.test (gen_expr Int) ~f:(fun e ->
                match (I1.interp e, I2.interp e) with
                | Val_Int int__048_, Val_Int int__047_ -> ())
          ...
          let int t () =
            Quickcheck.test (gen_expr IntT) ~f:(fun e ->
                match (I1.interp e, I2.interp e) with
                | Val_IntT intT__050_, Val_IntT intT__049_ -> ())
          ...
          let int t () =
            Quickcheck.test (gen_expr IntT) ~f:(fun e ->
                match (I1.interp e, I2.interp e) with
                | Val_IntT intT__052_, Val_IntT intT__051_ -> ())
