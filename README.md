...
- Stack
- Hash tables
- PriorityQueue (implementation by Harry Goldstein)
- Fqueue (purely functional queues, code from Real World OCaml)
- Foldable (code from Real World OCaml)
...
- ATTAPL Chapter 8
- Real World OCaml (Chapters 5, 10, 11, 17)
